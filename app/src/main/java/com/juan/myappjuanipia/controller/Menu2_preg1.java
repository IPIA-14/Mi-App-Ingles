...
public class Menu2_preg1 extends AppCompatActivity {
    ...
    public void sonarCorrecto(View view) {
        sonido = MediaPlayer.create(Menu2_preg1.this, R.raw.correcto);
        sonido.start();

        sonido.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mp) {
                Intent intent = new Intent(Menu2_preg1.this, Menu2_preg2.class);
    ...
    public void sonarInorrecto(View view){
        sonido = MediaPlayer.create(Menu2_preg1.this,R.raw.incorrecto);
        sonido.start();
    }
}